        ...
        <section className="flex flex-row-reverse w-full h-screen bg-white">
            <div className="flex flex-col w-1/3 items-center justify-center gap-y-6 mt-4">
                <div className="flex flex-col items-center">
                    <img src="/mango-icon.png" width={80} height={80} className="mb-4" />
                ...
                >
                    ...
                    <div className="flex flex-row items-center bg-gray-100 rounded-xl px-2 shadow-inner border-2 border-gray-200">
                        <FaKey className="text-xl mr-2 text-gray-500" />
                        <input
                    ...
                    <button
                        ...
                        py-3 rounded-lg transition-colors duration-200 bg-apricot-l1 hover:bg-apricot-l2 text-mauve-d2"
                    >
                        <span className="font-manrope">Ingresar</span>
                        <IoMdArrowForward />
                    </button>
                </form>
            ...
            <div className="w-2/3 h-full p-4">
                <img src="/hero-bg.png" className="object-cover w-full h-full rounded-2xl shadow-lg" />
            </div>
        </section>
    )
}